...
class ModelRouter{
    ...
    public getRoutes = () => {
        ...
        this.router.post("/", this.upload.any(), new ModelFileMiddleware().process, new ModelController().insert);
        this.router.put("/", this.upload.any(), new ModelFileMiddleware().process, new ModelController().update);
        this.router.delete("/",this.upload.any(), new ModelFileMiddleware().process, new ModelController().delete);
